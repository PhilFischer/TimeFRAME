...
namespace model_frame_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_frame");
    reader.add_event(37, 35, "end", "model_frame");
    return reader;
}
#include <stan_meta_header.hpp>
class model_frame
  : public stan::model::model_base_crtp<model_frame> {
private:
        int d;
        int N;
        int K;
        ...
        matrix_d sdev;
public:
    model_frame(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_frame_namespace::model_frame";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "alpha_r", "double", context__.to_vec());
            alpha_r = double(0);
            vals_r__ = context__.vals_r("alpha_r");
            pos__ = 0;
            alpha_r = vals_r__[pos__++];
            check_greater_or_equal(function__, "alpha_r", alpha_r, 0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_neq(alpha, 1))) {
                current_statement_begin__ = 31;
                for (int i = 1; i <= N; ++i) {
                    current_statement_begin__ = 31;
                    lp_accum__.add(dirichlet_log<propto__>(get_base1(f, i, "f", 1), rep_vector(alpha, K)));
                }
            }
            current_statement_begin__ = 32;
            if (as_bool(logical_neq(alpha_r, 1))) {
                current_statement_begin__ = 32;
                for (int l = 1; l <= L; ++l) {
                    current_statement_begin__ = 32;
                    lp_accum__.add(gamma_log<propto__>(get_base1(r, l, "r", 1), alpha_r, 1));
                }
            }
            ...
            for (int i = 1; i <= d; ++i) {
                current_statement_begin__ = 34;
                lp_accum__.add(normal_log<propto__>(get_base1(X, i, "X", 1), get_base1(mu, i, "mu", 1), get_base1(sdev, i, "sdev", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_frame_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_frame_namespace::model_frame stan_model;
#ifndef USING_R
