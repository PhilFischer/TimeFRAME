test_that("Spline model works", {
  ...
  sd <- x + 1
  testthat::expect_error(fit <- fit_glm(m, x, t, eta = 0))
  testthat::expect_no_error(fit <- fit_glm(m, x, t, eta = 1))
  ...
  testthat::expect_no_error(fit <- fit_glm(m, x, t, sd = sd))
  testthat::expect_vector(coef(fit, point.est = "mean"))
  testthat::expect_vector(coef(fit, point.est = "median"))
  testthat::expect_vector(as.data.frame(fit))
  testthat::expect_no_error(fit <- fit_glm(m, x, t, sd = sd, eta = 1))
  testthat::expect_vector(coef(fit, point.est = "mean"))
  testthat::expect_vector(coef(fit, point.est = "median"))
  testthat::expect_vector(as.data.frame(fit))
  testthat::expect_no_error(fit <- fit_glm(m, x, t, eta = c(1,1)))
  testthat::expect_vector(coef(fit, point.est = "mean"))
  testthat::expect_vector(coef(fit, point.est = "median"))
  testthat::expect_vector(as.data.frame(fit))
  testthat::expect_no_error(fit <- fit_glm(m, x, t, sd = sd, eta = c(1,1)))
  testthat::expect_vector(coef(fit, point.est = "mean"))
  testthat::expect_vector(coef(fit, point.est = "median"))
  testthat::expect_vector(as.data.frame(fit))
})
